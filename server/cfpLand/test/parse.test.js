...
function loadFixture() {
  eventFixture = fs.readFileSync(
    "server/cfpLand/test/eventFixture.txt",
    "utf8"
  );
}
...
describe("parseEvents", () => {
  ...
  it("returns objects with the correct data", () => {
    const actual = parseEvents(eventFixture)[0];
    expect(actual).toMatchObject({
      name: "PyCon Colombia 2020",
      location: "Medellín, Colombia",
      date: "February 7, 2020",
      url: "",
      cfpClose: "June 30, 2019",
      cfpUrl:
        "https://docs.google.com/forms/d/e/1FAIpQLSfnodEiHZ9dOzmG_x87ALE4xj_N4qF2in5cK21Mh0EfHrvKeQ/viewform",
      eventTags: "Python"
    });
  });
